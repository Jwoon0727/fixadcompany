        ...
        <div className="lg:pl-12">
          ...
          <div className="py-8 lg:py-4">
            ...
            <p className="text-base mt-4 text-gray-600">
              ...
              <br />
              <br />
              처음엔 일개 광고회사 사원으로 시작했습니다. 수많은 고객을 만나고, 그들의 브랜드를 함께 키워 오며 저 역시
              몇 년 동안 끊임없이 배우고 성장해 왔습니다.
              <br />
              <br />
              고객 한 분 한 분의 성과는 제게 단순한 결과가 아닌, 진심을 담은 마케팅의 가치를 다시금 깨닫게 해 주는
              동력이었습니다. 그러한 경험들이 쌓여 더 많은 분들과 진정성 있게 일하고 싶다는 마음으로 픽스애드 |
              JINSIMFIX Co., Ltd. 를 설립하게 되었습니다.
              <br />
              <br />
              SNS 플랫폼은 이제 언어와 문화를 넘어 브랜드를 연결하는 도구가 되었고, 디지털 광고는 단순 노출이 아닌
              글로벌 신뢰의 시작점이 되었습니다.
              <br />
              <br />
              픽스애드 | JINSIMFIX Co., Ltd. 는 N사 출신 개발자들과 함께 다른 곳에 없는 마케팅 솔루션을 직접 개발하며
              시장을 선도합니다.
              <br />
              <br />
