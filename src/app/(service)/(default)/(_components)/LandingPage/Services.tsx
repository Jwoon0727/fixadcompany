...
const services = [
  {
    ...
    title: "Google",
    subtitle: "구글",
    description: "SEO, 구글 비즈니스 프로필 관리 및 세팅, 리뷰 등",
    image: "/redesign/services/Google.jpg",
  },
  {
    number: "02",
    title: "Naver",
    subtitle: "네이버",
    description: "SEO, 플레이스, 블로그, 퍼포먼스 솔루션 등",
    image: "/redesign/services/Naver.jpg",
  },
  {
    number: "03",
    title: "Instagram",
    subtitle: "인스타그램",
    description: "퍼널 구축, 콘텐츠 기획, 계정 대행, CPC 등",
    image: "/redesign/services/Instagram.jpg",
  },
  {
    number: "04",
    title: "Xiaohongshu",
    ...
    image: "/redesign/services/Xiaohongshu.jpg",
  },
  {
    number: "05",
    title: "Dianping",
  ...
  },
  {
    ...
    title: "Influencer",
    subtitle: "인플루언서",
    description: "인플루언서, 셀럽, 유튜버 등",
    image: "/redesign/services/Influencer.jpg",
  },
];
